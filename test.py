...
def get_args_parser():
    ...
    # training
    parser.add_argument('--name', default='ResNet_50_nr3_1-6-9_fuse_SharedSqueeze&Excite_no_TrFo-multihead', type=str)
    parser.add_argument('--outdir', default='./results/run003', type=str)
