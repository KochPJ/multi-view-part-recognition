...
class MultiViewRGBD(nn.Module):
    def __init__(self, encoder: nn.Module, num_classes: int, num_views: int, fusion: nn.Module,
                 tf_layers: int = 0, dropout: float = 0.5,
                 multi_head_classification=False, rgbd_wise_multi_head=False):
...
if __name__ == '__main__':
    ...
    v = 3
    d = 1
    m = MultiView(ResNet('50', c), num_classes=c, num_views=v, fusion=__fusion__[f], tf_layers=1,
