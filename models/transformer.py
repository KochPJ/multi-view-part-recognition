...
class TransformerEncoderDecoder(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed):
        ...
        query_embed = query_embed.unsqueeze(0)#.permute(1, 0, 2)
...
if __name__ == '__main__':
    ...
    bs = 2
    l = 3
    src = torch.rand((bs, l, d))
    mask = None
    pos_embed = torch.rand((bs, l, d))
    query_embed = torch.rand((1, d))

    tf = TransformerEncoderDecoder(d_model=d, nhead=heads, num_encoder_layers=layers,
